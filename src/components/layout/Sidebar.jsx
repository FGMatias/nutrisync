...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      >
        {!collapsed && (
          <span style={{ fontWeight: 700, fontSize: 15, color: 'var(--primary)', letterSpacing: '-0.3px' }}>
            NutriSync
          </span>
        )}
        <button
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
          ...
          {!collapsed && (
            <div style={{ minWidth: 0 }}>
              <p style={{ fontSize: 12, fontWeight: 500, color: 'var(--sidebar-fg)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 120 }}>
